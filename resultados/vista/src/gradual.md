...
const vistas = {
  ...
  participacion: {
    ...
    texto: {
      subtitulo: "Participación electoral",
      descripcion:
...
const recinto_colores = {
  ...
  segunda: {
    validos: colormap_lineal("diferencia", [
      [-.5, "#f50303"],
      [-.25, "#ec9c9d"],
      [0., "#f1f1f1"],
      [.25, "#8cbcac"],
...
for (const feature of recintos.features) {
  ...
  feature.properties.invalido = resultado?.p
    ...
    : null;
  if (vuelta == "segunda") {
    feature.properties.diferencia = resultado
      ? resultado.r.PDC / feature.properties.total -
        resultado.r.LIBRE / feature.properties.total
      : 0;
  }
}
```
